...
public:
    ...
    const Transform& gradientTransform() const {
        return m_gradientTransform->gradientTransform().value();
    }
...
class SVGPatternElement final : public SVGPaintElement,
...
public:
    ...
    const Transform& patternTransform() const {
        return m_patternTransform->patternTransform().value();
    }

    Units patternUnits() const { return m_patternUnits->patternUnits().value(); }

    Units patternContentUnits() const {
        return m_patternContentUnits->patternContentUnits().value();
    }
